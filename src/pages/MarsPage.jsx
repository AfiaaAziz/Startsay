...
export default function MarsPage({ isContactOpen, setIsContactOpen }) {
          ...
          >
            ...
            >
              <p style={{ display: "inline-block", position: "relative" }}>
                The Mars campaign transports the legendary eyewear into a bold
                new dimension, set against a forged-in-red, Martian surface, our
                CGI film reimagines the terrain, the rover and the glasses as
                one unified vehicle of performance and design.
              </p>
            </div>
          </div>
          <div words-slide-up="" text-split="" style={{ opacity: 1 }}>
          ...
          >
            <div className="w-dyn-list">
              <div id="listNext" role="list" className="w-dyn-items">
                <div
                  project-title="Galaxy Watch8 Series"
                  role="listitem"
                  className="proj-item w-dyn-item"
                  data-index="0"
                  style={{}}
